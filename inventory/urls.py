...
router.register(r'stocks_purchase', views.StockPurchaseViewSet, basename='stocks_purchase')
...
layer2_router = routers.NestedDefaultRouter(router, r'layer1s', lookup='layer1')
layer2_router.register(r'layer2s', views.Layer2ViewSet, basename='layer2')

account_router = routers.NestedDefaultRouter(router, r'layer2s', lookup='layer2')
account_router.register(r'accounts', views.CreateAccountViewSet, basename='account')

stock_router = routers.NestedDefaultRouter(router, r'stocks_purchase', lookup='stocks_purchase')
stock_router.register(r'stocks', views.StockViewSet, basename='stock')

sale_item_router = routers.NestedDefaultRouter(router, r'sales', lookup='sales')
sale_item_router.register(r'sale_items', views.SaleItemViewSet, basename='sale_item')
